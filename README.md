# Laravel 5.2 for Laravel Shift

This repository contains the latest version of Laravel 5.2. It is used as a reference by [Laravel Shift - the automated way to upgrade Laravel](https://laravelshift.com).
